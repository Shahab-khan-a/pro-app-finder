...
export default function AppIconGridCard({
  ...
  const renderAppIcon = () => {
    if (!currentIconSrc || iconStage >= 3) {
      ...
      return (
        <div className="w-full h-full rounded-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 flex items-center justify-center text-white font-black text-lg shadow-inner select-none">
          {initials}
        </div>
      );
    }
